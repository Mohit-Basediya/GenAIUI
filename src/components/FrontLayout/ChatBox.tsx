    ...
    >
      <div>
        <div className="prompt-response user" id="textInput">
          What is the revenue of XYZ corporation?
        </div>
      </div>
      ...
      <div id="promptBoxChat">
        <div className="prompt-response bot">
          <div id="summaryResult" ref={summaryResultRef}>
            ...
            <p id="summary">
              XYZ Corporation's financial statement for February 5, 2024 shows a
              revenue of $500,000 and a net income of $150,000. The company has
              $425,000 in total assets and $175,000 in total liabilities. They
              have $75,000 in ending cash and $200,000 in revenue primarily from
              product sales.
            </p>
            <p className="block-title">QA Corner:</p>
            <div className="pdf-qa-list">
              <p className="question">
                What is the financial revenue of XYZ Corporation?
              </p>
              <p className="answer">
                Revenue of $500,000 and a net income of $150,000. The company
                has $425,000 in total assets and $175,000 in total liabilities.
              </p>
              <p className="question">
                What is the financial revenue of XYZ Corporation?
              </p>
