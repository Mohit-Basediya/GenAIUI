  ...
  >
    <div className="audio-processing-container-body">
      <div id="mainProgressBar" className="audio-upload-progress">
        ...
        <div id="progressBarWithRemoveBtn">
          ...
          <div style={{ display: "none" }} className="progress-bar-container">
            <progress
        ...
        <p className="file-upload-status" id="selectedFileName"></p>
      </div>

      <div className="upload-audio-cta">
        {/* <input type="file" id="pdfFile" name="inputFile" accept=".pdf" style="display: none" /> */}
      ...
      <div className="start-over-container">
        <a className="nav-link" href="/newgendoc">
          <button
            type="button"
            id="generateDoc"
