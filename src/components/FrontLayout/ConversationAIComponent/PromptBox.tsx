...
const PromptBox = ({ visibility, callAPI, setLoading, filename }: any) => {

  const [question, setQuestion] = useState("");

  const handleButtonClick = async (e: React.MouseEvent<HTMLDivElement | HTMLButtonElement>) => {
    e.preventDefault();
  ...
  return (
    <div id="prompt-box" className="prompt-box" style={{ display: visibility }}>
